...
export class Message {
  ...
  @Prop({ reflectToAttr: true, mutable: true }) closeable : boolean = false
  @Prop({ reflectToAttr: true, mutable: true }) type : type | null
  @Prop({ reflectToAttr: true, mutable: true }) timeout : number = 5000
  @Prop({ reflectToAttr: true, mutable: true }) state : state = 'init'
